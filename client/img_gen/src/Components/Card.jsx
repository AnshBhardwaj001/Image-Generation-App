...
const Card = ({_id , name , prompt , photo}) => {
  return (
    <div className='rounded-x1 group relative shadow-card hover:shadow-cardhover card'>
      <img className='w-full h-auto object-cover rounded-x1'
       src={photo} alt={prompt} />
       <div className='group-hover:flex flex-col max-h-[94.h%] hidden absolute bottom-0 left-0 right-0 bg-[#10131f] m-2 p-4 rounded-md'>
